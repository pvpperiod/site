/* ========================================
   ...
   Express.js с авторизацией и хранением в файле
   ======================================== */
...
// Middleware
app.use(cors());
app.use(express.json({ limit: '50mb' })); // Увеличено для аватаров (base64)
...
app.post('/api/register', async (req, res) => {
  try {
    ...
    // Создаём пустой файл данных пользователя
...
// Получить данные пользователя (требует авторизации)
...
// Сохранить данные пользователя (требует авторизации)
...
// Проверка токена / получение инфо пользователя
